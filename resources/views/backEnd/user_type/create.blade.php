            ...
            <div class="card card-body">
                <div class="row">
                    ...
                    <div class="col-md-8 col-xl-9 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                        ...
                        <a href="{{route('user-type.index')}}" class="btn btn-info d-flex align-items-center">
             ...
             <div class="card card-body">
                 <form method="post" action="{{route('user-type.store')}}">
                     ...
                     <div class="row">
                         <div class="col-lg-6">
                             <div class="mb-4">
                                 <label for="title" class="form-label fw-semibold">User Type title</label>
                                 <input type="text" name="title" class="form-control" id="title" placeholder="User Type title">
                             </div>
                         </div>
                         <div class="col-lg-6">
                             <div class="mb-4">
