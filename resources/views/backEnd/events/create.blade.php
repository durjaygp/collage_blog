                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="mt-3 col-md-8 text-end d-flex justify-content-md-end justify-content-center mt-md-0">
                            <a href="{{route('admin-events.index')}}" class="btn btn-info d-flex align-items-center">
                                <i class="text-white ti ti-list-details me-1 fs-5"></i> Events List
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="title" class="form-control" id="blog_title" placeholder="Service Title" value="{{ old('title') }}" required>
                                </div>
                            </div>
