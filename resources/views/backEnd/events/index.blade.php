                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-8 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                            <a href="{{route('admin-events.create')}}" class="btn btn-info d-flex align-items-center">
                                <i class="ti ti-new-section text-white me-1 fs-5"></i> Add Service
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="table-responsive">
                                <table id="zero_config"
                                    ...
                                    <tr>
                                        ...
                                        <td>{{\Illuminate\Support\Str::limit($row->title,20)}}</td>
                                        <td>{{\Illuminate\Support\Str::limit($row->description,20)}}</td>
                                        <td>
                                            <div class="action-btn">
                                                <a href="{{route('service.edit',$row->id)}}" class="btn btn-sm btn-primary">
                                                ...
                                                <form id="delete-form-{{ $row->id }}" action="{{ route('service.destroy', $row) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
